...
public class Agent {
    ...
    public static class NeuralNetwork {
        ...
        public NeuralNetwork(File filesDir_) {
        ...
        private class BuildRunnable implements Runnable{
            ...
            BuildRunnable(NeuralNetwork ai_, boolean showInfo_) {
                super();
                this.ai = ai_;
        ...
        private class TrainRunnable implements Runnable {
            ...
            TrainRunnable(NeuralNetwork ai_,int nIterations_, boolean showInfo_) {
                super();
                this.ai = ai_;
